...
**作成日**: 2025年1月14日
**更新日**: 2026年1月20日 (Coupling/Clustering機能追加)
**用途**: 論文用図表の素材
...
│  │  └────────────┘ └────────────┘ └────────────┘ └────────────┘       │   │
│  │  ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌────────────┐       │   │
│  │  │ Two-Axis   │ │ Tradeoff   │ │ Shapley    │ │ Coupling   │       │   │
│  │  │ Evaluation │ │ Analysis   │ │ Breakdown  │ │ Clustering │       │   │
│  │  └────────────┘ └────────────┘ └────────────┘ └────────────┘       │   │
│  │  ┌────────────┐ ┌────────────┐                                     │   │
│  │  │ OPM 3D     │ │ Dendrogram │                                     │   │
│  │  │ View       │ │ Viewer     │                                     │   │
...
│  │                                                                      │   │
│  │  ┌──────────────────────┐    ┌──────────────────────┐               │   │
│  │  │ shapley_calculator   │    │ coupling_calculator  │               │   │
│  │  │                      │    │                      │               │   │
│  │  │ - Shapley値計算      │    │ - 正規化カップリング │               │   │
│  │  │ - 寄与度分解         │    │ - 間接結合度行列     │               │   │
│  │  │ - ノード/エッジ寄与  │    │ - 階層的クラスタリング│              │   │
│  │  └──────────────────────┘    └──────────────────────┘               │   │
│  │                                                                      │   │
│  │  ┌──────────────────────┐    ┌──────────────────────┐               │   │
│  │  │ scc_analyzer         │    │ discretization_conf  │               │   │
│  │  │                      │    │                      │               │   │
│  │  │ - Tarjanアルゴリズム │    │ - 符号保存確率       │               │   │
│  │  │ - スペクトル半径     │    │ - 順序保存確率       │               │   │
│  │  │ - ループ解消提案     │    │                      │               │   │
...
### 4.4 カップリング/クラスタリング計算フロー

```
  CouplingClusteringPanel       API                  coupling_calculator
         │                       │                          │
         │  GET /coupling/       │                          │
         │  {proj}/{case}        │                          │
         │──────────────────────>│                          │
